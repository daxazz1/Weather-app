...
function showWeatherInDom(data) {
    ...
    // /prognoze siai dienai
     ...
     //prognoze po 2 dienu
        ...
        document.getElementById("h4-1").innerHTML = data.list[0].dt_txt;
        document.getElementById("h4-2").textContent = data.list[6].dt_txt;
        document.getElementById("h4-3").textContent = data.list[14].dt_txt;
